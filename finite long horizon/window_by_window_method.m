...
for loop_count=1:my_loop 
    ...
    for i=1:T
        ...
        [col_index_sigma_start] = sigma_col_index_new(A,B,k,1,Ha_temp,window_stage_counter,T); %By setting k_present=1 and Ha as Ha_temp we are getting the first value of the column index for this specific sigma
        ...
        [col_index_tau_start] = tau_col_index_new(A,B,l,1,Hb_temp,window_stage_counter,T); %By setting l_present=1 and Hb as Hb_temp we are getting the first value of the column index for this specific sigma
    ...
    while stage_counter<N
        ...
        for j=1:T
            ...
            [col_index_tau_plus_start] = tau_col_index_new(A,B,l,1,Hb_temp,window_stage_counter,T); %For t=1 and specific Hb this is my Y*. In this case no matter what the Hb is, it is not using it as t=1.
            ...
            [col_index_sigma_plus_start] = sigma_col_index_new(A,B,k,1,Ha_temp,window_stage_counter,T); %For t=1 and specific Ha this is my X*. In this case no matter what the Ha is, it is not using it as t=1.
